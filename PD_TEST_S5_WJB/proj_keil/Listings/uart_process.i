...
#line 26 "..\\src\\uart_process.c"

#line 34 "..\\src\\uart_process.c"
...
static void SC2ComInit(uint32_t baud)
{
	...
	CLK_EnableModuleClock(((((2UL) & 0x03) << 30)|(((2) & 0x1f) << 0) | (((3) & 0x03) << 28)|(((3) & 0x07) << 25)|(((4) & 0x1f) << 20)| (((1) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((16) & 0x1f) << 5)));
	 
	CLK_SetModuleClock(((((2UL) & 0x03) << 30)|(((2) & 0x1f) << 0) | (((3) & 0x03) << 28)|(((3) & 0x07) << 25)|(((4) & 0x1f) << 20)| (((1) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((16) & 0x1f) << 5)), (0x0UL<<4), (((1)-1) << 16));

	 
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP &= ~((1UL<<12) | (1UL<<13));
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP |= (1UL<<12) | (1UL<<13);
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~((1UL<<11) | ((1UL<<2) | (1UL<<11)));
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |= 0x00000000UL | 0x00000000UL;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 &= ~((1UL<<5) | (1UL<<6));
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 |= (1UL<<11) | (1UL<<10);

	SCUART_Open(((SC_T *) ((( uint32_t)0x40100000) + 0x98000)), baud);
	
	SCUART_SetLineConfig(((SC_T *) ((( uint32_t)0x40100000) + 0x98000)), baud, (0), (0), ((1ul << 15)));
...
void SC2SendRadarData(void)
{
	...
	SCUART_Write(((SC_T *) ((( uint32_t)0x40100000) + 0x98000)), txbuf, sizeof(txbuf));
}
...
void BoardComInit(void)
{
   ...
   UART_SetLine_Config(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), 115200, (3), (0x0 << 3), (0x0 << 2));

   UART_EnableInt(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), (1ul << 0));

   NVIC_EnableIRQ(UART1_IRQn);
   
   NVIC_SetPriority(UART1_IRQn, (1 << 2) - 2);

   comInfo.uart = ((UART_T *) ((( uint32_t)0x40100000) + 0x50000));
   comInfo.rxqueue = 0;
   comInfo.txqueue = 0;
   comInfo.rxbuf = 0;
   ...
   UART_SetLine_Config(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), 115200, (3), (0x0 << 3), (0x0 << 2));
			...
			if (pComInfo->rx_cnt == 5) {
				...
				if (pComInfo->cmd_len > 256) {
					...
					if (!plist_node) {
						...
						pComInfo->rxbuf = ((uint8_t *)(plist_node) + sizeof(list_t));
						plist_node->next = 0;
			...
			if (pComInfo->rxbuf) {
				...
				if (pComInfo->rx_cnt >= pComInfo->cmd_len) {
					if (pComInfo->chksum == 0) {
						plist_node = ((list_t *)((uint8_t *)pComInfo->rxbuf - sizeof(list_t)));
...
{
    if((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->IER & ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR) & 0x3)     
	{
...
{
    if((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->IER & ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->ISR) & 0x3)     
    {
    	Uart1IrqHandler(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)));
    }
}
...
void WaitUartFifoEmpty(void)
{
	...
	while(!(((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 22)));
