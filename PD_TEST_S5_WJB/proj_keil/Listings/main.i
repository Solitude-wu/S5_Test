...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((28) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((2) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0xFF) & 0xff) << 10)|(((16) & 0x1f) << 5)), (0x0UL<<2), (((119)-1) << 16));  

     
    CLK_EnableModuleClock(((((0) & 0x03) << 30)|(((1) & 0x1f) << 0) | (((0x0) & 0x03) << 28)|(((0x0) & 0x07) << 25)|(((0x0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));

    SysTick_Config(1000*CyclesPerUs);
    NVIC_SetPriority(SysTick_IRQn, (1 << 2) - 3);
...
void send_power_info_by_can(void)
{
	...
	volt = ADC_GetChanVolt(7);
	curr = ADC_GetChanVolt(6);
		...
		if (sys_time - last_time > 10) {
			...
			if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) == 0) {				
				...
				if (prepare_sleep_delay == 0)
					prepare_sleep_delay = 150;														
			}
			ign_stat = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) == 0 ? 1:0;  	
			if (last_ign_stat != ign_stat) {					
