...
#line 35 "..\\Library\\StdDriver\\src\\can.c"
...
int32_t CAN_SetRxMsgObjAndMsk(CAN_T *tCAN, uint8_t u8MsgObj, uint8_t u8idType, uint32_t u32id, uint32_t u32idmask, uint8_t u8singleOrFifoLast)
{
    ...
    if(u8idType == 0)     
    {
        ...
        tCAN->IF[u8MsgIfNum].MASK2 = (1ul << 15) | (1ul << 14) | (u32idmask & 0x7FF) << 2;
    }
    else
    {
        ...
        tCAN->IF[u8MsgIfNum].MASK2 = (1ul << 15) | (1ul << 14) | (u32idmask & 0x1FFF0000) >> 16;
    }
