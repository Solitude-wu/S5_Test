...
#line 12 "..\\Library\\StdDriver\\src\\scuart.c"
...
static uint32_t SCUART_GetClock(SC_T *sc)
{
    ...
    u32ClkSrc = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL3 >> (2 * u32Num)) & (3ul << 0);
    ...
    u32Clk /= (((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV1 >> (8 * u32Num)) & (0xFFul << 0)) + 1);
...
uint32_t SCUART_SetLineConfig(SC_T* sc, uint32_t u32Baudrate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t  u32StopBits)
{
    ...
    sc->CTL = u32StopBits | (1ul << 0);  
    sc->UACTL = u32Parity | u32DataWidth | (1ul << 0);  
