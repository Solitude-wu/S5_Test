 ...
 * $Revision: 3 $
 * $Date: 15/05/08 2:51p $
 * @brief    NUC230_240 series RTC driver header file
 *
 * @note
...
typedef struct
{
    uint16_t u32Year;           /*!< Year value */
    uint8_t u32Month;          /*!< Month value */
    uint8_t u32Day;            /*!< Day value */
    uint8_t u32DayOfWeek;      /*!< Day of week value */
    uint8_t u32Hour;           /*!< Hour value */
    uint8_t u32Minute;         /*!< Minute value */
    uint8_t u32Second;         /*!< Second value */
    uint8_t u32TimeScale;      /*!< 12-Hour, 24-Hour */
    uint8_t u32AmPm;           /*!< Only Time Scale select 12-hr used */
} S_RTC_TIME_DATA_T;
#endif
